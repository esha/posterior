...
* 2014-10-13 [v0.7.1][] (support all XHR events, JSON default, resolve/reject promise with response/error, request/responseData handler support)
...
[v0.7.1]: https://github.com/esha/jcx/tree/0.7.1
