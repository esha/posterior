...
* 2018-02-09 [v0.22.1][] ('xhr' debug mode, index.d.ts fixes, consistent context for requestData & responseData functions)
...
[v0.22.1]: https://github.com/esha/posterior/tree/0.22.1
