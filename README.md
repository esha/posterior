...
* 2018-02-12 [v0.22.5][] ('capture' debug mode, notable index.d.ts fixes/changes, stop binding all functions to metaCfg context)
...
[v0.22.5]: https://github.com/esha/posterior/tree/0.22.5
